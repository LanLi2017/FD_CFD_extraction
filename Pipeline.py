...
def run(xml_path='BART-master/Bart_Engine/misc/resources/employees/employees-dbms-50-egtask.xml',
        clean_data_path='Database/exp_data/employee_50_egtask_clean',
        dirty_data_path='Database/exp_data/employee_50_egtask_dirty',
    ...
    error_rate_e1 = list(zip(left_error_rate, right_error_rate))
