...
def main():
    ...
    axes[0, 0].plot(er_tane, old_acc_list, 'r', label='original data')
    axes[0, 0].plot(er_tane, new_acc_list, 'g', label='prepared data')
    axes[0, 0].set_xlabel('Threshold for TANE')
    axes[0, 0].set_ylabel('accuracy')

    axes[0, 1].plot(er_tane, old_recall_list, 'r')
    axes[0, 1].plot(er_tane, new_recall_list, 'g')
    axes[0, 1].set_xlabel('Threshold for TANE')
    axes[0, 1].set_ylabel('Recall')

    axes[1, 0].plot(er_tane, old_prec_list, 'r')
    axes[1, 0].plot(er_tane, new_prec_list, 'g')
    axes[1, 0].set_xlabel('Threshold for TANE')
    axes[1, 0].set_ylabel('Precision')

    axes[1, 1].plot(er_tane, old_f1_list, 'r')
    axes[1, 1].plot(er_tane, new_f1_list, 'g')
    axes[1, 1].set_xlabel('Threshold for TANE')
